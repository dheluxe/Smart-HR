                ...
                <div class="card-body employee-detail-edit-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <?php echo Form::label('name', __('Name'),['class'=>'form-control-label']); ?><span
                                class="text-danger pl-1">*</span>
                            <?php echo Form::text('name', null, ['class' => 'form-control','required' => 'required']); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo Form::label('phone', __('Phone'),['class'=>'form-control-label']); ?><span
                                class="text-danger pl-1">*</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <?php echo Form::label('dob', __('Date of Birth'),['class'=>'form-control-label']); ?><span
                                    class="text-danger pl-1">*</span>
                        ...
                        <div class="col-md-6 ">
                            <div class="form-group ">
                                <?php echo Form::label('gender', __('Gender'),['class'=>'form-control-label']); ?><span
                                    class="text-danger pl-1">*</span>
                                <div class="d-flex radio-check">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="g_female" value="Female" name="gender"
                                               class="custom-control-input" <?php echo e(($employee->gender == 'Female')?'checked':''); ?>>
                    ...
                    <div class="form-group">
                        <?php echo Form::label('address', __('Address'),['class'=>'form-control-label']); ?><span
                            class="text-danger pl-1">*</span>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="select2 form-control select2-multiple" id="designation_id"
                                        ...
                                        data-placeholder="<?php echo e(__('Select Designation ...')); ?>">
                                    <option value=""><?php echo e(__('Select any Designation')); ?></option>
                                </select>
                            </div>
                            <?php if(\Auth::user()->id != $employee->user_id): ?>
                                <div class="form-group col-md-6">
                                    <?php echo e(Form::label('type', __('Role'),['class'=>'form-control-label'])); ?>

                                    <?php echo e(Form::select('type', $roles,null,array('class' => 'form-control select2','id'=>'type','required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?> border-0"
                                                    <?php if($document->is_required == 1 && empty($employeedoc[$document->id]) ): ?> required
                                                    <?php endif; ?> name="document[<?php echo e($document->id); ?>]" type="file"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/Marshall/PhpstormProjects/Smart-HR/resources/views/employee/edit.blade.php ENDPATH**/ ?>