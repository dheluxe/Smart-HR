                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(\Auth::user()->type == 'employee'): ?>
                                                ...
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <?php if(\Auth::user()->id != \Auth::user()->getEmployee($leave->employee_id)->user_id ): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/Marshall/PhpstormProjects/Smart-HR/resources/views/leave/index.blade.php ENDPATH**/ ?>