            ...
            <div class="card card-fluid">
                ...
                <div class="card-body employee-detail-create-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('role_id', __('Role'),['class'=>'form-control-label'])); ?>

                            <?php echo e(Form::select('role_id', $roles,null,array('class' => 'form-control select2','id'=>'role_id','required'=>'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/Marshall/PhpstormProjects/Smart-HR/resources/views/employee/create.blade.php ENDPATH**/ ?>