<div class="card bg-none card-box">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            <?php echo e(Form::label('project', __('Project'),['class'=>'form-control-label'])); ?>

            <?php echo e(Form::text('project', '', array('class' => 'form-control','required'=>'required'))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('activity', __('Activity'),['class'=>'form-control-label'])); ?>

            <?php echo e(Form::text('activity', '', array('class' => 'form-control','required'=>'required'))); ?>
        ...
        <div class="form-group  col-md-12">
            <?php echo e(Form::label('remark', __('Comments'),['class'=>'form-control-label'])); ?>
...
<?php /**PATH /home/Marshall/PhpstormProjects/Smart-HR/resources/views/timeSheet/create.blade.php ENDPATH**/ ?>