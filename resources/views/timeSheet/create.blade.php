<div class="card bg-none card-box">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::text('project', '', array('class' => 'form-control','required'=>'required')) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('activity', __('Activity'),['class'=>'form-control-label']) }}
            {{ Form::text('activity', '', array('class' => 'form-control','required'=>'required')) }}
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group  col-md-12">
            {{ Form::label('remark', __('Comments'),['class'=>'form-control-label']) }}
